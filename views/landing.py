...
class LandingWindow(QtWidgets.QMainWindow):
    ...
    def _go_to_login(self):
        ...
        try:
            ...
            # fallback: show message box so devs know import failed
            QtWidgets.QMessageBox.information(self, "Next screen", "LoginWindow not found. Please ensure entrysafe.views.login exists.")
            return

        self.login_win = LoginWindow()
        self.login_win.show()
        # close the splash (or hide) to hand over to login
        self.close()
